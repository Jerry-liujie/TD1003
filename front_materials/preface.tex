...
The author used Anthropic's Claude
% TODO(Jie): extend this list if other tools (e.g., ChatGPT, GitHub
% Copilot) were used, and adjust the description to match.
as a writing and editing assistant during the preparation and revision
