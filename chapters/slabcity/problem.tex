...
This section presents the query language and integrity constraints considered by \toolname, followed by our problem definition. 

%\subsection{Query Space}
%\label{slab:sec:querylanguage}

\head{Query space}
See Figure~\ref{slab:fig:querysyntax} for the formal language that supports a wide subset of SQL such as arbitrary nesting and join patterns. 
...
Below are the types of integrity constraints \slabcity currently supports:
