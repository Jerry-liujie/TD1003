\section{Query Rewriting and Program Synthesis}
...
We also briefly discuss how data provenance is related to (and different from) the concept of query dataflow in this chapter, since they might look similar to each other. 
