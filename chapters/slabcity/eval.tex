...
%\caption{On 100K-sized DB.}
\end{minipage}
\hfill 
\begin{minipage}{.32\linewidth}
\includegraphics[width=\linewidth]{chapters/slabcity/figs/time_LeetCode_1M.pdf}
%\caption{On 1M-sized DB.}
\end{minipage}
\hfill
\begin{minipage}{.32\linewidth}
\includegraphics[width=\linewidth]{chapters/slabcity/figs/time_LeetCode_10M.pdf}
%\caption{On 10M-sized DB.}
\end{minipage}
\vspace{-10pt}
\caption*{\small (b) Latency reduction: left is on 100K, middle is 1M, and right is 10M. ``GM'' means geometric mean.}
...
\end{minipage}
\vspace{-10pt}
\caption*{\small (b) Latency reduction: left is on 250K, middle is 1M, right is 4M. ``GM'' means geometric mean.}
